package Perl::Dist::Strawberry::BuildPerl::5140;

=pod

=begin readme text

Perl::Dist::Strawberry::BuildPerl::5140 version 2.50
...
Perl::Dist::Strawberry::BuildPerl::5140 - Files and code for building Perl 5.14.0

=head1 VERSION

This document describes Perl::Dist::Strawberry::BuildPerl::5140 version 2.50.
...
around '_install_perl_plugin' => sub {
	...
	my $perl = Perl::Dist::WiX::Asset::Perl->new(
		parent => $self,
		url    => 'http://strawberryperl.com/package/perl-5.14.0.tar.bz2',
		toolchain => $toolchain,
		patch     => [ qw{
			  lib/CPAN/Config.pm
			  win32/config.gc
		...
		license => {
			'perl-5.14.0/Readme'   => 'perl/Readme',
			'perl-5.14.0/Artistic' => 'perl/Artistic',
			'perl-5.14.0/Copying'  => 'perl/Copying',
		},
	);
	$perl->install();
...
around '_find_perl_file' => sub {
	...
	$location = eval {
		File::ShareDir::module_file(
			'Perl::Dist::Strawberry::BuildPerl::5140', $file );
	};
